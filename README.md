...
```sh
git clone https://github.com/budschi/unicornone-rheed.git
cd unicornone-rheed
...
```sh
pip install dist/unicornone-rheed-0.1.0
```
...
| Name | E-mail     |
|------|------------|
| Sebastian Brückner | [sebastian.brueckner@physik.hu-berlin.de](mailto:sebastian.brueckner@physik.hu-berlin.de)
